import { type AugmentationSet, type MergeStrategies } from '@rhombus-std/primitives';
/**
 ...
 * ```
 */
export declare function registerAugmentations<R>(set: AugmentationSet<R>, merge?: MergeStrategies<R>): void;
export declare const REGISTER_AUGMENTATIONS_NAME = "registerAugmentations";
